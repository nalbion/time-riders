...
public class ChangeBike : EditorWindow {
    ...
    void OnGUI() {
        ...
        GUILayout.Space(125);
        Texture tex1 = (Texture)AssetDatabase.LoadAssetAtPath("Assets/SimpleMotorcyclePhysics/Editor/Editor Icons/1.png", typeof(Texture));
        Texture tex2 = (Texture)AssetDatabase.LoadAssetAtPath("Assets/SimpleMotorcyclePhysics/Editor/Editor Icons/2.png", typeof(Texture));
        Texture tex3 = (Texture)AssetDatabase.LoadAssetAtPath("Assets/SimpleMotorcyclePhysics/Editor/Editor Icons/3.png", typeof(Texture));
        Texture tex4 = (Texture)AssetDatabase.LoadAssetAtPath("Assets/SimpleMotorcyclePhysics/Editor/Editor Icons/4.png", typeof(Texture));
        ...
        EditorGUI.LabelField(new Rect(25 + 360, 40, 100, 15), "Body 4:");
        if (tex4 != null)
